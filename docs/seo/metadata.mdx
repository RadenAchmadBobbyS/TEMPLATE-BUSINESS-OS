...
This section covers the configuration and usage of metadata within Business OS.
...
## Next Steps
To learn more about Metadata and how it integrates into Business OS, explore the related categories in the sidebar.
