...
const features = [
  {
    ...
    description:
      'Drag-and-drop editor with real-time preview. Build professional pages without writing code.',
  },
  {
    icon: Sparkles,
    tag: 'AI',
    ...
    description:
      'Generate content, optimize SEO, and automate workflows with built-in AI capabilities.',
  },
  {
    icon: Database,
    tag: 'DATA',
    title: 'Headless CMS',
    description:
      'Create custom content models for blogs, products, testimonials — any structured data you need.',
  },
  {
    icon: BarChart3,
    tag: 'TRACK',
    ...
    description:
      'Track visitors, conversions, funnels, and goals. Make data-driven decisions for your business.',
  },
  {
    icon: Search,
    tag: 'RANK',
    ...
    description:
      'Meta tags, Open Graph, sitemaps, redirects, and structured data — all from one dashboard.',
  },
  {
    icon: Globe,
    tag: 'ROUTE',
    ...
    description:
      'Connect your own domain with automatic SSL. Manage DNS verification and routing seamlessly.',
  },
  {
    icon: Rocket,
    tag: 'SHIP',
    ...
    description:
      'Deploy your website globally with a single click. Track deployments and roll back instantly.',
  },
  {
    icon: ImageIcon,
    tag: 'ASSET',
    title: 'Media Library',
    description:
      'Upload, organize, search, and process images with folders, favorites, and format conversion.',
  },
];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg" style={{ color: 'var(--slate)' }}>
              One platform replaces dozens of tools — build, publish, manage content, track
              analytics, and optimize for search from a single dashboard.
            </p>
          </div>
          <StaggerContainer
            className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-px sm:grid-cols-2 lg:grid-cols-4"
            ...
            {features.map((feature) => (
              ...
              >
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <span className="font-data text-[10px]" style={{ color: 'var(--slate)' }}>
                    {feature.tag}
                  </span>
                </div>
                <h3 className="font-display mb-2 font-semibold">{feature.title}</h3>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative mx-auto mt-16 max-w-5xl">
            <div
              className="absolute top-6 right-0 left-0 hidden h-px sm:block"
              style={{ backgroundColor: 'var(--line)' }}
            />
            <StaggerContainer className="grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-6">
              {workflow.map((item, i) => (
                <StaggerItem key={item.step} className="relative text-center">
                  ...
                  <h3 className="font-display text-sm font-semibold">{item.step}</h3>
        ...
        <Reveal className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-lg" style={{ color: 'var(--slate)' }}>
                Whether you&apos;re a startup, agency, or enterprise — BusinessOS adapts to your
                workflow with workspaces, team collaboration, and granular permissions.
              </p>
              ...
              <div className="grid grid-cols-2 gap-6">
                {stats.map((stat) => (
                  <div key={stat.label} className="text-center">
                    ...
                    <div className="font-data mt-1 text-xs" style={{ color: 'var(--slate)' }}>
                      {stat.label}
                    </div>
                  </div>
                ))}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Reveal className="bg-ink dark:border-line relative overflow-hidden px-8 py-16 text-center sm:px-16 dark:border dark:bg-white/5">
            ...
            <p className="text-paper dark:text-slate relative mx-auto mt-4 max-w-xl text-lg opacity-70">
              Join thousands of businesses that use BusinessOS to create, manage, and grow their
              online presence.
            </p>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
            <div>
              ...
              <ul className="space-y-2 text-sm" style={{ color: 'var(--slate)' }}>
                ...
                <li>
                  <a href="#cta" className="hover:opacity-100">
                    Pricing
                  </a>
                </li>
                <li>
