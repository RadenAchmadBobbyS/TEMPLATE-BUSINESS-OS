...
This section covers the configuration and usage of sitemap within Business OS.
...
## Next Steps
To learn more about Sitemap and how it integrates into Business OS, explore the related categories in the sidebar.
