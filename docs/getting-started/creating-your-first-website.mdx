...
This feature (`Creating Your First Website`) has either not yet been fully implemented in the codebase or its precise behavior is pending documentation audit. 
