...
This section covers the configuration and usage of export within Business OS.
...
## Next Steps
To learn more about Export and how it integrates into Business OS, explore the related categories in the sidebar.
