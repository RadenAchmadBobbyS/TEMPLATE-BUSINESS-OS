...
This section covers the configuration and usage of notifications within Business OS.
...
## Next Steps
To learn more about Notifications and how it integrates into Business OS, explore the related categories in the sidebar.
