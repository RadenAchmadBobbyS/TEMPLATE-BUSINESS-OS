...
This section covers the configuration and usage of status within Business OS.
...
## Next Steps
To learn more about Status and how it integrates into Business OS, explore the related categories in the sidebar.
