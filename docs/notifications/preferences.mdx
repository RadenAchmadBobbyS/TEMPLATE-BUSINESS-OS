---
title: "Preferences"
description: "Documentation for preferences"
---
...
This section covers the configuration and usage of preferences within Business OS.
...
## Next Steps
To learn more about Preferences and how it integrates into Business OS, explore the related categories in the sidebar.

<CardGrid>
  <Card title="Back to notifications" href="/docs/notifications">Return to category overview</Card>
</CardGrid>
