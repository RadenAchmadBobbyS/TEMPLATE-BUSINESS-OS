...
This section covers the configuration and usage of settings within Business OS.
...
## Next Steps
To learn more about Settings and how it integrates into Business OS, explore the related categories in the sidebar.

<CardGrid>
  <Card title="Back to workspace" href="/docs/workspace">Return to category overview</Card>
</CardGrid>
