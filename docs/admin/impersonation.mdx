---
title: "Impersonation"
description: "Documentation for impersonation"
---
...
This section covers the configuration and usage of impersonation within Business OS.
...
## Next Steps
To learn more about Impersonation and how it integrates into Business OS, explore the related categories in the sidebar.

<CardGrid>
  <Card title="Back to admin" href="/docs/admin">Return to category overview</Card>
</CardGrid>
