...
This section covers the configuration and usage of database within Business OS.
...
## Next Steps
To learn more about Database and how it integrates into Business OS, explore the related categories in the sidebar.
