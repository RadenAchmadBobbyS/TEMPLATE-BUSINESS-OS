...
description: "Documentation for structured data"
---
...
This section covers the configuration and usage of structured data within Business OS.
...
## Next Steps
To learn more about Structured data and how it integrates into Business OS, explore the related categories in the sidebar.

<CardGrid>
  <Card title="Back to seo" href="/docs/seo">Return to category overview</Card>
</CardGrid>
