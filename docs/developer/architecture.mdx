...
This section covers the configuration and usage of architecture within Business OS.
...
## Next Steps
To learn more about Architecture and how it integrates into Business OS, explore the related categories in the sidebar.
