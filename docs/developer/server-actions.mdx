...
description: "Documentation for server actions"
---
...
This section covers the configuration and usage of server actions within Business OS.
...
## Next Steps
To learn more about Server actions and how it integrates into Business OS, explore the related categories in the sidebar.
