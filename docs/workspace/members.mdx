...
This section covers the configuration and usage of members within Business OS.
...
## Next Steps
To learn more about Members and how it integrates into Business OS, explore the related categories in the sidebar.
