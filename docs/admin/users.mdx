...
This section covers the configuration and usage of users within Business OS.
...
## Next Steps
To learn more about Users and how it integrates into Business OS, explore the related categories in the sidebar.
