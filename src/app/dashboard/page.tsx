...
export default async function DashboardPage() {
  ...
  if (!active) {
    return (
      <div className="bg-background relative -m-4 h-[calc(100vh-4rem)] w-full overflow-hidden md:-m-8">
        <StaggerContainer
          className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-center gap-6 px-4 py-4 md:px-8"
        ...
        >
          ...
          <StaggerItem className="relative grid grid-cols-1 items-center gap-8 lg:grid-cols-[1fr_1.1fr]">
            <div className="relative hidden h-64 lg:block">
              <div
                className="pointer-events-none absolute inset-0"
                style={{
                  background:
                    'radial-gradient(420px circle at 15% 20%, color-mix(in srgb, var(--signal) 12%, transparent), transparent 65%), radial-gradient(360px circle at 85% 90%, color-mix(in srgb, var(--amber) 10%, transparent), transparent 65%)',
                }}
              />
              ...
              <div className="absolute top-8 left-6 w-56 -rotate-6 border-2 border-[var(--ink)] bg-[var(--paper)] p-3 shadow-[6px_6px_0px_var(--ink)]">
                ...
                <div className="mt-3 h-12 w-full bg-[var(--line)]" />
              </div>
              ...
              <div className="absolute top-0 left-24 w-56 rotate-3 border-2 border-[var(--ink)] bg-[var(--paper)] p-3 shadow-[8px_8px_0px_var(--ink)]">
                ...
                <div className="mt-3 h-14 w-full bg-gradient-to-br from-[var(--signal)]/20 to-[var(--amber)]/15" />
              </div>
              ...
              <div className="absolute bottom-8 left-0 flex items-center gap-1.5 border-2 border-[var(--ink)] bg-[var(--paper)] px-2.5 py-1.5 shadow-[4px_4px_0px_var(--ink)]">
  ...
  return (
    <div className="bg-background relative -m-4 h-[calc(100vh-4rem)] w-full overflow-hidden md:-m-8">
      ...
      <StaggerContainer
        className="relative z-10 mx-auto flex h-full max-w-7xl flex-col gap-4 px-4 py-4 md:px-8"
        style={{ fontFamily: 'Inter, sans-serif' }}
      >
        <StaggerItem className="shrink-0">
          <PageHeader
        ...
        {/* Bento row — plain divs, NOT the shared Card (which clips overflow internally),
            so the floating badge can sit half outside the border without being cut off */}
        <StaggerItem className="grid shrink-0 grid-cols-1 gap-4 lg:grid-cols-[1.6fr_1fr]">
          <div
            className="relative flex min-h-[210px] flex-col justify-between rounded-none border-2 bg-[var(--paper)] p-6"
            style={{
              borderColor: 'var(--ink)',
          ...
          >
            ...
            {/* decoration layer — clipped to itself only */}
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
              <span
                aria-hidden
                className="font-display absolute -top-4 -right-2 text-[7rem] leading-none font-bold select-none"
              ...
              <div
                aria-hidden
                className="absolute right-6 bottom-4 grid grid-cols-6 gap-1.5 opacity-[0.15]"
              >
              ...
              <div
                ...
                style={{
                  background:
                    'radial-gradient(340px circle at 92% 4%, color-mix(in srgb, var(--signal) 14%, transparent), transparent 65%)',
                }}
              />
            </div>

            {/* badge — free to overlap the border, nothing above it clips */}
            <div className="absolute top-0 left-6 z-20 -translate-y-1/2">
              <div className="inline-flex items-center gap-1.5 border-2 border-[var(--ink)] bg-[var(--ink)] px-3 py-1.5">
                <Globe className="h-3.5 w-3.5" style={{ color: 'var(--paper)' }} />
            ...
            <div className="relative z-10 mt-4 flex items-start justify-between">
              <div>
                ...
                <div
                  className="font-display text-6xl leading-none font-bold tracking-tight"
                  style={{ color: 'var(--ink)' }}
                >
                  {websitesCount}
                </div>
                <p className="mt-2.5 text-xs" style={{ color: 'var(--slate)' }}>
            ...
            <div
              className="relative z-10 mt-4 flex items-center gap-2 border-t pt-3"
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
              ...
              <div
                ...
                style={{
                  background:
                    'radial-gradient(300px circle at 6% 96%, color-mix(in srgb, var(--amber) 12%, transparent), transparent 65%)',
                }}
              />
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex -space-x-3">
                ...
                {membersCount > 5 && (
                  <div
                    className="font-data flex h-12 w-12 items-center justify-center border-2 text-xs font-bold"
                    style={{
                      borderColor: 'var(--paper)',
            ...
            {active.role !== 'EDITOR' && (
              <Link href="/dashboard/team" className="relative z-10">
                <Button
                  variant="outline"
                  className="mt-4 h-10 w-full rounded-none border-[var(--ink)] text-xs font-medium transition-colors hover:bg-[var(--ink)] hover:text-white"
                >
        ...
        {/* Recent websites — fills remaining space, tiles sized generously via h-full */}
        <StaggerItem className="flex min-h-0 flex-1 flex-col">
          ...
          {recentWebsites.length === 0 ? (
            <div
              className="relative flex min-h-0 flex-1 flex-col items-center justify-center rounded-none border-2 bg-[var(--paper)] text-center"
              style={{ borderColor: 'var(--ink)', boxShadow: '4px 4px 0px var(--ink)' }}
            >
              <CornerMarks />
              <Globe className="mb-2 h-7 w-7" style={{ color: 'var(--signal)' }} />
              ...
              {recentWebsites.map((website, i) => {
                ...
                return (
                  <Link
                    ...
                    className="group relative flex h-full min-h-[150px] flex-col overflow-hidden border-2 bg-[var(--paper)] transition-transform hover:-translate-y-1"
                    style={{ borderColor: 'var(--ink)', boxShadow: '4px 4px 0px var(--ink)' }}
                  >
                    <div
