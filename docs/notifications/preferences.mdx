...
This feature (`Notification Preferences`) has either not yet been fully implemented in the codebase or its precise behavior is pending documentation audit. 
