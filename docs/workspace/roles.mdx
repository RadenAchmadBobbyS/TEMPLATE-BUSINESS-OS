...
This section covers the configuration and usage of roles within Business OS.
...
## Next Steps
To learn more about Roles and how it integrates into Business OS, explore the related categories in the sidebar.
