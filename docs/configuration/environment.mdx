...
This section covers the configuration and usage of environment within Business OS.
...
## Next Steps
To learn more about Environment and how it integrates into Business OS, explore the related categories in the sidebar.

<CardGrid>
  <Card title="Back to configuration" href="/docs/configuration">Return to category overview</Card>
</CardGrid>
