---
title: "Marketplace"
description: "Documentation for marketplace"
---
...
This section covers the configuration and usage of marketplace within Business OS.
...
## Next Steps
To learn more about Marketplace and how it integrates into Business OS, explore the related categories in the sidebar.

<CardGrid>
  <Card title="Back to templates" href="/docs/templates">Return to category overview</Card>
</CardGrid>
