...
This section covers the configuration and usage of email within Business OS.
...
## Next Steps
To learn more about Email and how it integrates into Business OS, explore the related categories in the sidebar.
